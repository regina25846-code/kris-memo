...
function createTray() {
  ...
  const menu = Menu.buildFromTemplate([
    ...
    { label: '버그 신고', click: () => shell.openExternal('https://github.com/regina25846-code/kris-memo/discussions/categories/버그-신고') },
    { label: '기능 제안', click: () => shell.openExternal('https://github.com/regina25846-code/kris-memo/discussions/categories/유저-기능-제안') },
    { type: 'separator' },
    { label: '프로그램 정보', click: () => {
